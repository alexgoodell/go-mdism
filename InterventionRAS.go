...
func interventionInitiate(Intervention Intervention) {
	...
	case "control":
		...
		// TODO: Give Alex the new InterventionValue file and tell him to change the two lines that adjust the low risk TP here. [Issue: https://github.com/alexgoodell/go-mdism/issues/59]
